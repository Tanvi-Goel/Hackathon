    ...
    <Layout>
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <h1 className="text-center text-5xl font-bold mt-5 text-cyan-700">
            SKILLPROOF
          </h1>
          ...
          <div className="grid grid-cols-2 gap-10 mt-8">
            <div className="text-center">
              ...
              <h2 className="text-6xl font-bold text-cyan-700">
                {proof.score}/100
              </h2>
            </div>
        ...
        <div className="bg-slate-950/90 rounded-3xl p-8 mt-10 border border-cyan-700">
...
<div className="bg-slate-950/90 rounded-3xl p-8 border border-cyan-700">
...
<div className="bg-slate-950/90 rounded-3xl p-8 border border-cyan-700">
        ...
        <button
          ...
          className="mt-10 w-full bg-cyan-500 hover:bg-cyan-400 py-4 rounded-xl flex justify-center items-center gap-3 transition duration-200"
        >
          <Download size={20} />
